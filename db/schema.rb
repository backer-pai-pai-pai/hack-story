...
ActiveRecord::Schema.define(version: 20150822075324) do
  ...
  add_index "images", ["project_item_id"], name: "index_images_on_project_item_id", using: :btree
